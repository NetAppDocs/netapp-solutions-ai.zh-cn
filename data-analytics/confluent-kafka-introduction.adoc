...
NetApp instaclustr 从 3.8.1 版本开始也支持 Kafka 分层存储。请点击此处查看更多详情 link:https://www.instaclustr.com/support/documentation/kafka-add-ons/using-kafka-tiered-storage/["使用 Kafka 分层存储的 Instaclust"]
